...
describe('MessagesService', () => {
  ...
  describe('createMessage', () => {
    ...
    it('should return existing message with created set to false', async () => {
      jest.spyOn(prismaService.message, 'findFirst').mockResolvedValue(existingMessage);
    ...
    it('should create and return new message with created set to true', async () => {
      ...
      expect(prismaService.message.create).toHaveBeenCalledWith({data: {message: testMessage}});
    });
  });
  ...
  describe('messages', () => {
    ...
    it('should return messages for given ids', async () => {
      jest.spyOn(prismaService.message, 'findMany').mockResolvedValue(testMessages);
